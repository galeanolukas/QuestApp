...
requirements = python3,kivy,chardet,idna,urllib3,requests,android,androidstorage4kivy
...
presplash.filename = %(source.dir)s/data/splashscreen.png

# (str) Icon of the application
icon.filename = %(source.dir)s/data/icono.png
